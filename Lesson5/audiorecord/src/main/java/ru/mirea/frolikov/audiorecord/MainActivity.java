package ru.mirea.frolikov.audiorecord;
...
import ru.mirea.frolikov.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordButton.setText("Начать запись.25, БСБО-01-20");
